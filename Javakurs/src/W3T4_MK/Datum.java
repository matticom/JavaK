...
public class Datum implements Comparable<Datum>
{
	...
	public boolean equals(Object that)
	{
		...
		if ((((Datum)that).getTag() == this.getTag()) && (((Datum)that).getMonat() == this.getMonat()) && (((Datum)that).getJahr() == this.getJahr()))
			return true;
		else
			return false;
	...
	public int hashCode()
	{
		...
		String datum = new DecimalFormat("00").format(getTag()) + 
				new DecimalFormat("00").format(getMonat()) + new DecimalFormat("0000").format(getJahr());
