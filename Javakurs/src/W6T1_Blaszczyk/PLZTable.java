...
public class PLZTable extends JDialog implements ActionListener
{
	...
	private void initializeComponents()
	{
		...
		miSchliessen = WinUtil.createMenuItem(menuDatei, null, MenuItemType.ITEM_PLAIN, this, "Schließen", null, 'S', null);
		menuBearbeiten = WinUtil.createMenu(menuBar, "Bearbeiten", null, 'B');
		miNeu = WinUtil.createMenuItem(menuBearbeiten, null, MenuItemType.ITEM_PLAIN, this, "Neu", null, 'N', null);
		miAendern = WinUtil.createMenuItem(menuBearbeiten, null, MenuItemType.ITEM_PLAIN, this, "Ändern", null, 'Ä', null);
		miLoeschen = WinUtil.createMenuItem(menuBearbeiten, null, MenuItemType.ITEM_PLAIN, this, "Löschen", null, 'L', null);
