...
public class WinUtil
{
	...
	/**
	 * <li><b><i>createMenuExt</i></b> <br>
	 * <br>
	 * public JMenu createMenu(JMenuBar menuBar, String menuText, String deutsch, String spanisch, int shortKey) <br>
	 * <br>
	 * Erstellt einen Menü. <br>
	 * <br>
	 * 
	 ...
	 *            - Der Text des Menüs.
	 * @param deutsch
	 *            - Deutsche Beschriftung des Menus.
	 * @param spanisch
	 *            - Spanische Beschriftung des Menus.
	 * @param shortKey
	 *            - Optionales Tastaturkürzel oder <b>0</b>.
	 * @return Menü.
	 */

	public static JMenu createMenuExt(JMenuBar menuBar, String menuText, String deutsch, String spanisch, int shortKey)
	{
		...
		menu = new JMenu();
		menu.setText(menuText);
		menu.setName(deutsch);
		menu.setToolTipText(spanisch);
	...
	/**
	 * <li><b><i>createSubMenuExt</i></b> <br>
	 * <br>
	 * public JMenu createSubMenu(JMenu mainMenu, String menuText, String deutsch, String spanisch, int shortKey) <br>
	 * <br>
	 * Erstellt ein Untermenü. <br>
	 * <br>
	 * 
	 ...
	 *            - Der Text des Menüs.
	 * @param deutsch
	 *            - Deutsche Beschriftung des Buttons.
	 * @param spanisch
	 *            - Spanische Beschriftung des Buttons.
	 * @param shortKey
	 *            - Optionales Tastaturkürzel oder <b>0</b>.
	 * @return - Untermenü.
	 */
	public static JMenu createSubMenuExt(JMenu mainMenu, String menuText, String deutsch, String spanisch, int shortKey)
	{
	...
	public static JButton createButton(String buttonText, int x, int y, int width, int height, Border border, Color background, ActionListener actionListener,
			String deutsch, String spanisch, boolean setOpaque, boolean setFocusPainted, Color foreground)
	{
	 ...
	 * @param deutsch
	 *            - Deutsche Beschriftung des Labels
	 * @param spanisch
	 *            - Spanische Beschriftung des Labels
	 * @param foreground
	 *            - Optionale Setzt Schriftfarbe <b>null</b>.
	 * @return - JLabel.
	 */
	public static JLabel createLabel(String LblText, int x, int y, int width, int height, Border border, Color background, 
										String deutsch, String spanisch, Color foreground)
	{
