...
public class FrameDialogSuchenUndErsetzen extends JDialog implements ActionListener, ComponentListener
{
	...
	private static FrameDialogSuchenUndErsetzen instanz;
	private int xpos, ypos;
	//private static boolean posFlag;
	...
	{
		if (instanz == null)
			instanz = new FrameDialogSuchenUndErsetzen(textArea);
//		else 
//			posFlag = true;
