...
public class Felder
{
	...
	public static void main(String[] args)
	{
		...
		// Verlust in 'int' konvertieren lässt.
		// Dazu gehören byte, short, und char.
		// Günstig ist ein Index vom Typ char z.B. als Laufvariable, wenn
		...
		// Für die Ausgabe von mehrdimensionalen Arrays im Standardformat gibt es die Methode
		// Arrays.deepToString().
