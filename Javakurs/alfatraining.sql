...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 23. Aug 2016 um 20:53
...
(31, 'Baumassenzahl', 'Ocupacion', 20, 'Die Baumassenzahl ist das Verhältnis des geplanten oder gebauten Volumens von Gebäuden und Gebäudeteilen auf einem Grundstück zur Größe (Fläche) des Grundstücks und gibt an wie viel Kubikmeter Bauvolumen pro Quadratmeter gebaut wird.', 'La ocupación es la relación entre el volumen de las edificaciones de una parcela y el area de la pareclo y se da en m3 por m2 de parcela.');
...
--
ALTER TABLE `fachgebiete`
  MODIFY `PRIMARYKEY` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
-- AUTO_INCREMENT für Tabelle `lexikon`
--
ALTER TABLE `lexikon`
  MODIFY `PRIMARYKEY` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
